...
exports.hot = fromStringRenderer('hot');

/**
 * hot string support.
 */

exports.hot.render = function (str, it, fn) {
  var engine = requires.hot || (requires.hot = require('hot'));
    try {
        var settings, def = {};
        if (!cacheStore[str])
            cacheStore[str] = {tmpl: engine.template(str, settings, def), def: def};
    	var c = cacheStore[str];
    	it.def = c.def;
